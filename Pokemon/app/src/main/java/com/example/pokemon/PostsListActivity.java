...
public class PostsListActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.More){
            Intent intent1 = new Intent(this, MoreStuff.class);
            this.startActivity(intent1);
            return true;
        }

        if (id == R.id.gallery){
            Intent intent1 = new Intent(this, Pictures.class);
            this.startActivity(intent1);
            return true;
        }
    ...
    private void showSortDialog() {
        ...
        builder.setTitle("Sort by") //set title
                .setIcon(R.drawable.baseline_sort_by_alpha_black_18dp) //set icon
